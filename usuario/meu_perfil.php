...
<div class="container mt-4">
    <form id="formPerfil">
        <img width="100px" height="100px" src="<?php echo $imagem_perfil; ?>" alt="Imagem do perfil" class="img-thumbnail rounded-circle mx-auto d-block" id="imgPerfil" style="cursor:pointer;">
